...
class EntryFlow(nn.Module):
    def __init__(self, grayscale=False):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(image_channel, 32, 3, padding=1, bias=False),
            nn.BatchNorm2d(32),
...
class Xception(nn.Module):
    def __init__(self, block, grayscale=False, num_class=100):
        super().__init__()
        self.entry_flow = EntryFlow(grayscale)
...
def xception(grayscale=False, num_classes=100):
    return Xception(MiddleFLowBlock, grayscale=grayscale, num_classes=num_classes)
