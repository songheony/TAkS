...
class ShuffleNet(nn.Module):
    def __init__(self, num_blocks, grayscale=False, num_classes=100, groups=3):
        super().__init__()
        ...
        self.conv1 = BasicConv2d(image_channel, out_channels[0], 3, padding=1, stride=1)
...
def shufflenet(grayscale=False, num_classes=100):
    return ShuffleNet([4, 8, 4], grayscale=grayscale, num_classes=num_classes)
