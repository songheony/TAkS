...
class ShuffleNetV2(nn.Module):
    def __init__(self, ratio=1, grayscale=False, class_num=100):
        super().__init__()
        if ratio == 0.5:
        ...
        self.pre = nn.Sequential(
            nn.Conv2d(image_channel, 24, 3, padding=1), nn.BatchNorm2d(24)
        )
...
def shufflenetv2(grayscale=False, num_classes=100):
    return ShuffleNetV2(grayscale=grayscale, class_num=num_classes)
