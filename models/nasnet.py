...
class NasNetA(nn.Module):
    def __init__(
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(image_channel, stemfilter, 3, padding=1, bias=False),
...
def nasnet(grayscale=False, num_classes=100):

    # stem filters must be 44, it's a pytorch workaround, cant change to other number
    return NasNetA(4, 2, 44, 44, grayscale=grayscale, class_num=num_classes)
