...
class InceptionV4(nn.Module):
    def __init__(
        self, A, B, C, k=192, l=224, m=256, n=384, grayscale=False, class_nums=100
    ):

        super().__init__()
        image_channel = 1 if grayscale else 3
        self.stem = Inception_Stem(image_channel)
...
class InceptionResNetV2(nn.Module):
    def __init__(
        self, A, B, C, k=256, l=256, m=384, n=384, grayscale=False, class_nums=100
    ):
        super().__init__()
        image_channel = 1 if grayscale else 3
        self.stem = Inception_Stem(image_channel)
...
def inceptionv4(grayscale=False, num_classes=100):
    return InceptionV4(4, 7, 3, grayscale=grayscale, class_num=num_classes)


def inception_resnet_v2(grayscale=False, num_classes=100):
    return InceptionResNetV2(5, 10, 5, grayscale=grayscale, class_num=num_classes)
