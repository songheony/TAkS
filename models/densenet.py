...
class DenseNet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            image_channel, inner_channels, kernel_size=3, padding=1, bias=False
        )
...
def densenet121(grayscale=False, num_classes=100):
    return DenseNet(
        Bottleneck,
        [6, 12, 24, 16],
        growth_rate=32,
...
def densenet169(grayscale=False, num_classes=100):
    return DenseNet(
        Bottleneck,
        [6, 12, 32, 32],
        growth_rate=32,
...
def densenet201(grayscale=False, num_classes=100):
    return DenseNet(
        Bottleneck,
        [6, 12, 48, 32],
        growth_rate=32,
...
def densenet161(grayscale=False, num_classes=100):
    return DenseNet(
        Bottleneck,
        [6, 12, 36, 24],
        growth_rate=48,
