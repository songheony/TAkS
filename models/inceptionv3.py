...
class InceptionV3(nn.Module):
    def __init__(self, grayscale=False, num_classes=100):
        super().__init__()
        image_channel = 1 if grayscale else 3
        self.Conv2d_1a_3x3 = BasicConv2d(image_channel, 32, kernel_size=3, padding=1)
...
def inceptionv3(grayscale=False, num_classes=100):
    return InceptionV3(grayscale=grayscale, num_classes=num_classes)
